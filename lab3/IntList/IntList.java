...
public class IntList {
    ...
    /** Find the last node of the IntList L and return it. */
    ...
    public static IntList reverse(IntList L) {
        ...
        IntList reverseHead = L;
        IntList nextNodeToAdd = L.rest;

        reverseHead.rest = null;

        while (nextNodeToAdd != null) {
            IntList remainingHead = nextNodeToAdd.rest;
            nextNodeToAdd.rest = reverseHead;

            reverseHead = nextNodeToAdd;
            nextNodeToAdd = remainingHead;
        }
        L = reverseHead;
        return L;
    }
